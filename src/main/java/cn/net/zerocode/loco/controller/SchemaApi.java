...
public interface SchemaApi {
    ...
    @ApiOperation(value = "在线接口管理", nickname = "create", notes = "新增", tags = {"schema",})
    @RequestMapping(value = "/schema", method = RequestMethod.POST)
    R create(@ApiParam(value = "", required = true) @Valid @RequestBody Schema data);


    @ApiOperation(value = "在线接口管理", nickname = "delete", notes = "删除", tags = {"schema",})
    ...
    @ApiOperation(value = "在线接口管理", nickname = "list", notes = "查询", tags = {"schema",})
    ...
    @ApiOperation(value = "在线接口管理", nickname = "multipleDelete", notes = "在线接口管理", tags = {"schema",})
    @RequestMapping(value = "/schema/multiple_delete", method = RequestMethod.DELETE)
    R multipleDelete(@ApiParam(value = "", required = true) @Valid @RequestBody MultiDelete data);


    @ApiOperation(value = "在线接口管理", nickname = "partialUpdate", notes = "在线接口管理", tags = {"schema",})
    @RequestMapping(value = "/schema/{id}", method = RequestMethod.PATCH)
    R partialUpdate(@ApiParam(value = "Id", required = true) @PathVariable("id") Integer id, @ApiParam(value = "", required = true) @Valid @RequestBody Schema data);


    @ApiOperation(value = "在线接口管理", nickname = "postapi", notes = "用于前端菜单树结构树", tags = {"schema",})
    @RequestMapping(value = "/schema/postapi", method = RequestMethod.POST)
    R postapi(@ApiParam(value = "", required = true) @Valid @RequestBody Schema data);


    @ApiOperation(value = "在线接口管理", nickname = "read", notes = "单例", tags = {"schema",})
    @RequestMapping(value = "/schema/{id}", method = RequestMethod.GET)
    R read(@ApiParam(value = "Id", required = true) @PathVariable("id") Integer id);


    @ApiOperation(value = "在线接口管理", nickname = "update", notes = "修改", tags = {"schema",})
    @RequestMapping(value = "/schema/{id}", method = RequestMethod.PUT)
    R update(@ApiParam(value = "Id", required = true) @PathVariable("id") Long id, @ApiParam(value = "", required = true) @Valid @RequestBody Schema data);
